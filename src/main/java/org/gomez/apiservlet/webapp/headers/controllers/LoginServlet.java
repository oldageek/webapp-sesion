...
import org.gomez.apiservlet.webapp.headers.services.*;
...
public class LoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (usernameOptional.isPresent()) {
            ...
            try (PrintWriter out = resp.getWriter()) {
                ...
                out.println("   </head>");
                out.println("   <body>");
                out.println("       <h1>Hola " + usernameOptional.get() + " has iniciado sesion anteriormente!</h1>");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (usuarioOptional.isPresent()) {
            ...
            resp.sendError(HttpServletResponse.SC_UNAUTHORIZED, "No esta autorazado para ingresar a esta pagina");
        }
    }
}
